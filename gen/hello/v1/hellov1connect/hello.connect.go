...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/nurazon59/connect-go-sandbox/gen/hello/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	HelloServiceHelloProcedure = "/hello.v1.HelloService/Hello"
)
...
func (UnimplementedHelloServiceHandler) Hello(context.Context, *connect.Request[v1.HelloRequest]) (*connect.Response[v1.HelloResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("hello.v1.HelloService.Hello is not implemented"))
}
