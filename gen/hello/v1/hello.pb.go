...
func (x *HelloRequest) GetNumber() int64 {
	if x != nil {
		return x.Number
	}
	return 0
...
func (x *HelloRequest) GetStr() string {
	if x != nil {
		return x.Str
	}
	return ""
...
const file_hello_v1_hello_proto_rawDesc = "" +
	"\n" +
	"\x14hello/v1/hello.proto\x12\bhello.v1\"8\n" +
	...
	"\fHelloService\x12:\n" +
	"\x05Hello\x12\x16.hello.v1.HelloRequest\x1a\x17.hello.v1.HelloResponse\"\x00B>Z<github.com/nurazon59/connect-go-sandbox/gen/hello/v1;hellov1b\x06proto3"
